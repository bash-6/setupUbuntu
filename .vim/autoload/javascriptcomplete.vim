  ...
  if a:findstart
	...
	if shortcontext =~ '\.$'
		...
		let documeth = ['close', 'createAttribute', 'createElement', 'createTextNode', 'focus', 'getElementById',
					\ 'getElementsByName', 'getElementsByTagName', 'open', 'write', 'writeln', 'querySelector',
					\ 'onClick', 'onDblClick', 'onFocus', 'onKeyDown', 'onKeyPress', 'onKeyUp', 'querySelectorAll',
